...
public class StaticShader extends ShaderProgram{
	...
	private static final String VERTEX_FILE = "src/com/rpggame/shaders/vertexShader.txt";
	private static final String FRAGMENT_FILE = "src/com/rpggame/shaders/fragmentShader.txt";
	...
	protected void getAllUniformLocations() {
		location_transfromationMatrix = super.getUniformLocation("transfromationMatrix");
